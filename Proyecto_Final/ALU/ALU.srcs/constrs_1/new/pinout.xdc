...
set_property PACKAGE_PIN T18 [get_ports {B[3]}]
...
set_property PACKAGE_PIN H17 [get_ports {R[4]}]
set_property PACKAGE_PIN K15 [get_ports {R[3]}]
set_property PACKAGE_PIN J13 [get_ports {R[2]}]
set_property PACKAGE_PIN N14 [get_ports {R[1]}]
