...
HD_PWD='C:/Users/Bobe/Documents/Vivado/Projects/Semaforos/Semaforos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Semaforos.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Semaforos.tcl
