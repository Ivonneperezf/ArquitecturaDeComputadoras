...
HD_PWD='C:/Users/Bobe/Documents/Vivado/Projects/Semaforos/Semaforos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Semaforos.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Semaforos.tcl -notrace
